...
namespace WebExtensions.Net.History
{
    ...
    public partial class OnVisitRemovedEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<AddListenerCallbackRemoved> callback)
        {
        ...
        public virtual ValueTask<bool> HasListener(Action<HasListenerCallbackRemoved> callback)
        {
        ...
        public virtual ValueTask RemoveListener(Action<RemoveListenerCallbackRemoved> callback)
        {
