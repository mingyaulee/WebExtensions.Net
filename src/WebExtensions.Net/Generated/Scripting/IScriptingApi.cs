...
public partial interface IScriptingApi
{
    ...
    /// <returns></returns>
    [JsAccessPath("getRegisteredContentScripts")]
    ValueTask<IEnumerable<RegisteredContentScript>> GetRegisteredContentScripts(ContentScriptFilter filter = null);
    ...
    [JsAccessPath("registerContentScripts")]
    ...
    [JsAccessPath("unregisterContentScripts")]
    ValueTask UnregisterContentScripts(ContentScriptFilter filter = null);
    ...
    [JsAccessPath("updateContentScripts")]
