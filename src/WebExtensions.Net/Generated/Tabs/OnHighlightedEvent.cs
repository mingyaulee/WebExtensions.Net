...
public partial class OnHighlightedEvent : Event
{
    ...
    public virtual void AddListener(Action<CallbackHighlightInfo> callback)
    ...
    public virtual bool HasListener(Action<CallbackHighlightInfo> callback)
        => Invoke<bool>("hasListener", callback);

    /// <summary>Deregisters an event listener <em>callback</em> from an event.</summary>
    /// <param name="callback">Listener that shall be unregistered.</param>
    [JsAccessPath("removeListener")]
    public virtual void RemoveListener(Action<CallbackHighlightInfo> callback)
