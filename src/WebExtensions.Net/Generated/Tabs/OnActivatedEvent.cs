...
namespace WebExtensions.Net.Tabs
{
    ...
    public class OnActivatedEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<AddListenerCallbackActiveInfo> callback)
        {
        ...
        public virtual ValueTask<bool> HasListener(Action<HasListenerCallbackActiveInfo> callback)
        {
        ...
        public virtual ValueTask RemoveListener(Action<RemoveListenerCallbackActiveInfo> callback)
        {
