...
namespace WebExtensions.Net.WebRequest
{
    ...
    public partial class OnSendHeadersEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<OnSendHeadersEventCallbackDetails> callback)
        {
        ...
        public virtual ValueTask AddListener(Action<OnSendHeadersEventCallbackDetails> callback, RequestFilter filter, IEnumerable<OnSendHeadersOptions> extraInfoSpec)
        {
        ...
        public virtual ValueTask<bool> HasListener(Action<OnSendHeadersEventCallbackDetails> callback)
        {
        ...
        /// <param name="extraInfoSpec">Array of extra information that should be passed to the listener function.</param>
        /// <returns>True if <em>callback</em> is registered to the event.</returns>
        public virtual ValueTask<bool> HasListener(Action<OnSendHeadersEventCallbackDetails> callback, RequestFilter filter, IEnumerable<OnSendHeadersOptions> extraInfoSpec)
        {
        ...
        public virtual ValueTask RemoveListener(Action<OnSendHeadersEventCallbackDetails> callback)
        {
        ...
        /// <param name="filter">A set of filters that restricts the events that will be sent to this listener.</param>
        /// <param name="extraInfoSpec">Array of extra information that should be passed to the listener function.</param>
        public virtual ValueTask RemoveListener(Action<OnSendHeadersEventCallbackDetails> callback, RequestFilter filter, IEnumerable<OnSendHeadersOptions> extraInfoSpec)
        {
