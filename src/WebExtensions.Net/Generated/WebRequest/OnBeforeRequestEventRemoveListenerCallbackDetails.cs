...
namespace WebExtensions.Net.WebRequest
{
    // Type Class
    /// <summary></summary>
    public partial class OnBeforeRequestEventRemoveListenerCallbackDetails : BaseObject
    {
        ...
        private RemoveListenerCallbackDetailsRequestBody _requestBody;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public RemoveListenerCallbackDetailsRequestBody RequestBody
        {
            get
            {
                InitializeProperty("requestBody", _requestBody);
                return _requestBody;
            }
            set
            {
