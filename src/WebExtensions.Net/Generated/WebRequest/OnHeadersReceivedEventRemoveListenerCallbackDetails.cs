...
namespace WebExtensions.Net.WebRequest
{
    // Type Class
    /// <summary></summary>
    public partial class OnHeadersReceivedEventRemoveListenerCallbackDetails : BaseObject
    {
        ...
        /// <summary>The HTTP response headers that have been received with this response.</summary>
        ...
        /// <summary>HTTP status line of the response or the 'HTTP/0.9 200 OK' string for HTTP/0.9 responses (i.e., responses that lack a status line).</summary>
