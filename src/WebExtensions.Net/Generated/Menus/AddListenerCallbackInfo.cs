...
namespace WebExtensions.Net.Menus
{
    ...
    public partial class AddListenerCallbackInfo : BaseObject
    {
        ...
        private IEnumerable<AddListenerCallbackInfoMenuIdsArrayItem> _menuIds;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public IEnumerable<AddListenerCallbackInfoMenuIdsArrayItem> MenuIds
        {
            get
            {
