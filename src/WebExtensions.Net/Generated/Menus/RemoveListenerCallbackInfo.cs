...
namespace WebExtensions.Net.Menus
{
    ...
    public partial class RemoveListenerCallbackInfo : BaseObject
    {
        ...
        private IEnumerable<RemoveListenerCallbackInfoMenuIdsArrayItem> _menuIds;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public IEnumerable<RemoveListenerCallbackInfoMenuIdsArrayItem> MenuIds
        {
            get
            {
