...
namespace WebExtensions.Net.Devtools.InspectedWindow
{
    ...
    public partial interface IInspectedWindowApi
    {
        ...
        /// <summary>Gets the 'tabId' property.</summary>
        /// <returns>The ID of the tab being inspected. This ID may be used with chrome.tabs.* API.</returns>
        ValueTask<int> GetTabId();
    }
}
