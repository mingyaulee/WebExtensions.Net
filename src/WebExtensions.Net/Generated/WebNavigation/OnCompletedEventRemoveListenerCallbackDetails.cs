...
namespace WebExtensions.Net.WebNavigation
{
    // Type Class
    /// <summary></summary>
    public partial class OnCompletedEventRemoveListenerCallbackDetails : BaseObject
    {
        ...
        /// <summary>The time when the document finished loading, in milliseconds since the epoch.</summary>
