...
namespace WebExtensions.Net.WebNavigation
{
    ...
    public class OnCompletedEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<OnCompletedEventAddListenerCallbackDetails> callback, EventUrlFilters filters)
        {
        ...
        /// <param name="filters">Conditions that the URL being navigated to must satisfy. The 'schemes' and 'ports' fields of UrlFilter are ignored for this event.</param>
        /// <returns>True if <em>callback</em> is registered to the event.</returns>
        public virtual ValueTask<bool> HasListener(Action<OnCompletedEventHasListenerCallbackDetails> callback, EventUrlFilters filters)
        {
        ...
        /// <param name="callback">Listener that shall be unregistered.</param>
        /// <param name="filters">Conditions that the URL being navigated to must satisfy. The 'schemes' and 'ports' fields of UrlFilter are ignored for this event.</param>
        public virtual ValueTask RemoveListener(Action<OnCompletedEventRemoveListenerCallbackDetails> callback, EventUrlFilters filters)
        {
