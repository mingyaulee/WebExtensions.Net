...
namespace WebExtension.Net.Tabs
{
    ...
    public enum ZoomSettingsMode
    {
        ...
        Automatic,
        /// <summary>
        /// Overrides the automatic handling of zoom changes. The <c>onZoomChange</c> event will still be dispatched, and it is the responsibility of the extension to listen for this event and manually scale the page. This mode does not support <c>per-origin</c> zooming, and will thus ignore the <c>scope</c> zoom setting and assume <c>per-tab</c>.
        /// </summary>
        [EnumValue("manual")]
        Manual,
        /// <summary>
