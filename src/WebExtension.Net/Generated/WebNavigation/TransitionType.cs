...
namespace WebExtension.Net.WebNavigation
{
    // Enum Definition
    /// <summary>
    /// Cause of the navigation. The same transition types as defined in the history API are used. These are the same transition types as defined in the $(topic:transition_types)[history API] except with <c>"start_page"</c> in place of <c>"auto_toplevel"</c> (for backwards compatibility).
    /// </summary>
