...
namespace WebExtension.Net.WebRequest
{
    ...
    public class OnCompletedEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<object> callback, RequestFilter filter, IEnumerable<OnCompletedOptions> extraInfoSpec)
        {
        ...
        /// <param name="extraInfoSpec">Array of extra information that should be passed to the listener function.</param>
        /// <returns>True if <em>callback</em> is registered to the event.</returns>
        public virtual ValueTask<bool> HasListener(Action<object> callback, RequestFilter filter, IEnumerable<OnCompletedOptions> extraInfoSpec)
        {
        ...
        /// <param name="filter">A set of filters that restricts the events that will be sent to this listener.</param>
        /// <param name="extraInfoSpec">Array of extra information that should be passed to the listener function.</param>
        public virtual ValueTask RemoveListener(Action<object> callback, RequestFilter filter, IEnumerable<OnCompletedOptions> extraInfoSpec)
        {
