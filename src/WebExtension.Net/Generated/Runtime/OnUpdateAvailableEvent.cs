...
namespace WebExtension.Net.Runtime
{
    ...
    public class OnUpdateAvailableEvent : Event
    {
        ...
        public virtual ValueTask AddListener(Action<OnUpdateAvailableEventAddListenerCallbackDetails> callback)
        {
        ...
        public virtual ValueTask<bool> HasListener(Action<OnUpdateAvailableEventHasListenerCallbackDetails> callback)
        {
        ...
        public virtual ValueTask RemoveListener(Action<OnUpdateAvailableEventRemoveListenerCallbackDetails> callback)
        {
