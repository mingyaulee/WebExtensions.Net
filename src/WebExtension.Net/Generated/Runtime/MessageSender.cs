...
namespace WebExtension.Net.Runtime
{
    ...
    public class MessageSender
    {
        ...
        /// Property Definition
        /// <summary>The $(topic:frame_ids)[frame] that opened the connection. 0 for top-level frames, positive for child frames. This will only be set when <code>tab</code> is set.</summary>
